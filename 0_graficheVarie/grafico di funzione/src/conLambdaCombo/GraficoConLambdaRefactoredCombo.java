...
public class GraficoConLambdaRefactoredCombo extends Application {

	static List<Function<Float,Float>> functions = List.of(
	...
	public void start(Stage stage){
		...
		ComboBox<Function<Float,Float>> combo = new ComboBox<>();
