...
public class AppointmentTest {
	...
	public void testEqualsAppointment() {
		Appointment app1 = new Appointment("Natale", LocalDateTime.of(2018, Month.DECEMBER, 24, 12, 0),
				Duration.of(10, ChronoUnit.MINUTES));
		Appointment app2 = new Appointment("Natale", LocalDateTime.of(2018, Month.DECEMBER, 24, 12, 0),
				Duration.of(10, ChronoUnit.MINUTES));
