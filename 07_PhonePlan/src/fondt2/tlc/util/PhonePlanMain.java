...
public class PhonePlanMain {
	public static PhonePlan createPlan() {
		DayOfWeek[] workWeek = new DayOfWeek[] { DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY,
				DayOfWeek.THURSDAY, DayOfWeek.FRIDAY };
		DayOfWeek[] weekEnd = new DayOfWeek[] { DayOfWeek.SATURDAY, DayOfWeek.SUNDAY };
		Band[] timBands = new Band[] { new Band(LocalTime.MIN, LocalTime.MAX, weekEnd, 0.10),
				new Band(LocalTime.MIN, LocalTime.of(8, 0).minusNanos(1), workWeek, 0.10),
				new Band(LocalTime.of(8, 0), LocalTime.of(18, 0).minusNanos(1), workWeek, 0.20),
				new Band(LocalTime.of(18, 0), LocalTime.MAX, workWeek, 0.10) };
		Rate tim = new Rate("TIM", timBands, 1000, 10, "+39339");

		Band[] vodafoneBands = new Band[] { new Band(LocalTime.MIN, LocalTime.MAX, weekEnd, 0.15),
				new Band(LocalTime.MIN, LocalTime.of(8, 0).minusNanos(1), workWeek, 0.15),
				new Band(LocalTime.of(8, 0), LocalTime.of(18, 0).minusNanos(1), workWeek, 0.30),
				new Band(LocalTime.of(18, 0), LocalTime.MAX, workWeek, 0.15) };
