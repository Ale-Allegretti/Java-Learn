...
public class FrazioneTest
{
	public static void main(String[] args) {
		...
		//test funzionamento size
		Frazione[] collezioneA = new Frazione[10]; // iniz. vuoto
		  collezioneA[0] = frazione1;
		  collezioneA[1] = frazione2;
		  collezioneA[2] = frazione3; 
		  collezioneA[3] = frazione4;
		  
		assert(Frazione.size(collezioneA) == 4);
		...
		//test funzionamento somma fra due array di frazioni
		...
		//test funzionamento prodotto fra due array di frazioni
