...
public class FractionCollectionTests {
	...
	public static void main(String[] args) {
		...
		FractionCollection c3 = new FractionCollection();
		c3.put(new Frazione(1, 1));
		c3.put(new Frazione(1, 2));
		c3.put(new Frazione(1, 3));
		c3.put(new Frazione(1, 4));
		
		FractionCollection c4 = new FractionCollection();
		c4.put(new Frazione(1, 1));
		c4.put(new Frazione(1, 2));
		c4.put(new Frazione(1, 3));
		c4.put(new Frazione(1, 4));

		FractionCollection resMul = c3.mul(c4);
		
		// assert
		assert(4==resMul.size());
		assert(new Frazione(1).equals(resMul.get(0))==true);
		assert(new Frazione(1, 4).equals(resMul.get(1))==true);
		assert(new Frazione(1, 9).equals(resMul.get(2))==true);
		assert(new Frazione(1, 16).equals(resMul.get(3))==true);
	}
